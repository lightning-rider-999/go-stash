## stash misc migrate-scene-screenshots

MigrateSceneScreenshots (mutation) [async job]

```
stash misc migrate-scene-screenshots [flags]
```

### Options

```
  -h, --help                    help for migrate-scene-screenshots
