## stash misc reveal-file-in-file-manager

RevealFileInFileManager (mutation)

```
stash misc reveal-file-in-file-manager [flags]
```

### Options

```
  -h, --help   help for reveal-file-in-file-manager
```
