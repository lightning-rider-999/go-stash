...
* [stash misc delete-files](stash_misc_delete-files.md)	 - DeleteFiles (mutation)
* [stash misc destroy-files](stash_misc_destroy-files.md)	 - DestroyFiles (mutation)
* [stash misc destroy-saved-filter](stash_misc_destroy-saved-filter.md)	 - DestroySavedFilter (mutation)
...
* [stash misc migrate-blobs](stash_misc_migrate-blobs.md)	 - MigrateBlobs (mutation) [async job]
