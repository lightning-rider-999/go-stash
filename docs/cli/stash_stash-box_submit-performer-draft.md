## stash stash-box submit-performer-draft

SubmitStashBoxPerformerDraft (mutation)

```
stash stash-box submit-performer-draft [flags]
```

### Options

```
  -h, --help   help for submit-performer-draft
```
