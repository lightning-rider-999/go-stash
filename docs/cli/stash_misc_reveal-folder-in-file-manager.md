## stash misc reveal-folder-in-file-manager

RevealFolderInFileManager (mutation)

```
stash misc reveal-folder-in-file-manager [flags]
```

### Options

```
  -h, --help   help for reveal-folder-in-file-manager
```
