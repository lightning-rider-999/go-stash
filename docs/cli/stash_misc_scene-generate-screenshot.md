## stash misc scene-generate-screenshot

SceneGenerateScreenshot (mutation)

```
stash misc scene-generate-screenshot [flags]
```

### Options

```
  -h, --help   help for scene-generate-screenshot
```
