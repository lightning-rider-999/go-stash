## stash misc validate-stash-box-credentials

ValidateStashBoxCredentials (query)

```
stash misc validate-stash-box-credentials [flags]
```

### Options

```
  -h, --help   help for validate-stash-box-credentials
```
