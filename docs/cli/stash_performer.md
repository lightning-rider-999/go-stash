...
* [stash performer destroy](stash_performer_destroy.md)	 - PerformerDestroy (mutation)
* [stash performer destroy-many](stash_performer_destroy-many.md)	 - PerformersDestroy (mutation)
...
* [stash performer merge](stash_performer_merge.md)	 - PerformerMerge (mutation)
