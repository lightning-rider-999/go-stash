## stash stash-box batch-performer-tag

StashBoxBatchPerformerTag (mutation) [async job]

```
stash stash-box batch-performer-tag [flags]
```

### Options

```
  -h, --help                    help for batch-performer-tag
