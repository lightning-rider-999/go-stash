...
* [stash tag destroy](stash_tag_destroy.md)	 - TagDestroy (mutation)
* [stash tag destroy-many](stash_tag_destroy-many.md)	 - TagsDestroy (mutation)
* [stash tag get](stash_tag_get.md)	 - FindTag (query)
* [stash tag list](stash_tag_list.md)	 - FindTags (query)
* [stash tag merge-many](stash_tag_merge-many.md)	 - TagsMerge (mutation)
